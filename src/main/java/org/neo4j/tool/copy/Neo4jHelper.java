...
import static brinqa.channel.neo4j.Util.DEFAULT_ID_PROP;
import static com.brinqa.composite.impl.TransformHelper.OBJECT_NODE;
...
public class Neo4jHelper {
  ...
  public static String buildPaginateIdsQuery(String nodeLabel) {
    ...
    final var idProp = node.property(DEFAULT_ID_PROP);
