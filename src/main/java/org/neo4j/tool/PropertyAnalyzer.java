...
public class PropertyAnalyzer {
    ...
    public static void main(String[] args) {
        ...
        for (Node node : db.getAllNodes()) {
            ...
            if (nodes % 1000 == 0) {
                System.out.print(".");
                if (nodes % 100000 == 0) System.out.println(" " + nodes);
            }
        }
        db.shutdown();
    ...
    private static int analyzeProperties(
            Map<String, PropertyInfo> props, PropertyContainer propertyContainer) {
    ...
    private static void update(
            Map<String, PropertyInfo> props, String property, PropertyContainer pc) {
    ...
    private static void outputEmptyCounts(
            int withoutProps, Map<String, PropertyInfo> props, int nodes, int rels) {
        System.out.println();
        ...
        System.out.printf(
                "%d of %d empty properties %d nodes %d rels pc w/o props %d%n",
                emptyCount, allCount, nodes, rels, withoutProps);
    }
    ...
    private static boolean isDefaultValue(Object property) {
        ...
        if (property instanceof Number)
            return ((Number) property).longValue() == 0
                    || ((Number) property).doubleValue() == 0.0D;
